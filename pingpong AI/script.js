...
var colors = ['#DEAA79', '#A888B5', '#EFB6C8', '#F72C5B', '#B1C29E'];
    ...
    update: function () {
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () { Pong.endGameMenu('You are Winner!'); }, 1000);
            } else {
        ...
        // Check to see if the ai/AI has won the round.
            ...
            this.over = true;
            setTimeout(function () { Pong.endGameMenu('You Lose!'); }, 1000);
        }
    },
